...
export default async function QuestionPage({ params }: QuestionPageProps) {
  try {
    ...
    const author = typeof question.metadata?.author === 'object' && question.metadata.author ? question.metadata.author : null
    ...
    const tags = question.metadata?.tags?.split(',').map(tag => tag.trim()).filter(Boolean) || []
